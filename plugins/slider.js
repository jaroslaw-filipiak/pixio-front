const WholePageSlider = class {
  ...
  init() {
    ...
    const sectionButtonContainer = this.createElement('div', {
      className: 'sectionButtonContainer'
    }, this.container)
    ...
    for (let index = 0; index < this.sections.length; index++) {
      ...
      if (this.sections.length > 1) {
        ...
        this.createElement('label', {
          htmlFor: sectionNavigationButton.id
        }, sectionButtonContainer)
      ...
      if (this.pagesPerSection[index].length > 1) {
        ...
        const pageButtonContainer = this.createElement('div', {
          id: `pageButtonContainer[${index}]`,
